...
Parent: [project plan](../project-plan.md). Status: active; Slice01 ready for CC.

## Slice breakdown

| Slice | Capability | Depends on | Status |
| --- | --- | --- | --- |
| [slice01-run-permissions](slice01-run-permissions/slice-plan.md) | Explicit run permissions, real denial controls and traceable build | Arc01/Slice01 CDC | Ready for CC |
