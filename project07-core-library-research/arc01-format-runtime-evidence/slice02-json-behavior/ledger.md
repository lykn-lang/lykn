...
| --- | --- | --- | --- | --- | --- | --- | --- |
| J2-01 | Corrected identified launch enforces narrow permissions | Arc03 CDC receipt plus actual argv/denied-read control | serious | PERM and B01 drift | open | — | Blocks execution |
