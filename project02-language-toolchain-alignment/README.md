...
| [arc16 · book-0.6.0-edition](arc16-book-0.6.0-edition/arc-plan.md) | Lykn Book 0.6.0 edition; full-surface review before release | **Open** — slice10 CDC-verified with book commit `6aa379d`; `D-2609-FOVL` routed; slice11 `js-overlap-compile-parity` opened |
