...
| [arc16 · book-0.6.0-edition](arc16-book-0.6.0-edition/arc-plan.md) | Lykn Book 0.6.0 edition; full-surface review before release | **Open** — slice09 CDC-verified with book commit `03b3818`; slice10 `language-surface-chapters` opened |
