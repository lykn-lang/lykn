...
| [arc09 · release-0.6.0](arc09-release-0.6.0/arc-plan.md) | Version bumps, release notes, publish | **Open** — slice01, slice02, and slice03 closed/CDC-verified; slice04 `operator-publication-and-tags` active |
