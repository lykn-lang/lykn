...
| [arc09 · release-0.6.0](arc09-release-0.6.0/arc-plan.md) | Version bumps, release notes, publish | **Open** — next Project02 arc after arc16 close |
...
| [arc16 · book-0.6.0-edition](arc16-book-0.6.0-edition/arc-plan.md) | Lykn Book 0.6.0 edition; full-surface review before release | **Open** — slice11 CC-closed with source commit `2a0cabf` and book commit `43cfebc`; slice12 `edition-close-and-release-gate` opened |
