...
| [arc16 · book-0.6.0-edition](arc16-book-0.6.0-edition/arc-plan.md) | Lykn Book 0.6.0 edition; full-surface review before release | **Open** — slice07 CC-closed with refreshed drift inventory; slice08 `js-fn-return-parity` opened before chapter work |
