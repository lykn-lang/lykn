...
| [arc16 · book-0.6.0-edition](arc16-book-0.6.0-edition/arc-plan.md) | Lykn Book 0.6.0 edition; full-surface review before release | **Open** — slice08 CC-closed with `D-2609-FNRT` fixed in release/0.6.x `8c66469`; slice09 `toolchain-and-project-structure-chapters` opened |
