...
| [arc09 · release-0.6.0](arc09-release-0.6.0/arc-plan.md) | Version bumps, release notes, publish | **Open** — slice01 closed/CDC-verified; slice02 `version-bump-release-notes-ci-chore` active |
