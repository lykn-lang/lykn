...
- **Open standalone work:** none. `02-artifact-homes` and
  ...
  green at HEAD.
- **Open arcs:** arc16 (slice01-slice10 closed/CDC-verified; slice11
  `js-overlap-compile-parity` CC-closed/CDC pending; slice12
