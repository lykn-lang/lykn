...
| **arc09 · release-0.6.0** | Version bumps, release notes, publish to JSR / npm / crates.io | all above, **incl. arc16 (book)** | **Open — next Project02 arc after arc16 close** |
...
- **Open standalone work:** none. `02-artifact-homes` and
  ...
  green at HEAD.
- **Open arcs:** arc09 release planning/release cut. arc16 is closed from CC's
  side; CDC verification remains pending.
