...
(`project02-language-toolchain-alignment/arc03-compiler-coherence/handoff-surface-kernel-separation-2026-05-14.md`) that
...
The Phase 1c audit (`project02-language-toolchain-alignment/arc03-compiler-coherence/design/phase-1c-classification-audit.md`)
...
`project02-language-toolchain-alignment/arc02-type-dts-generation/design/dd-56-canonical-form-spec-DRAFT.md`.
