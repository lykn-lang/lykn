...
| `docs/design-v0.6.0/arc16-book-0.6.0-edition/arc-plan.md` | Arc capability, provisional slice map, decision gates, and arc ledger context. |
| `docs/design-v0.6.0/arc16-book-0.6.0-edition/slice01-pre-book-decision-gate/slice-doc.md` | Slice scope, exit criteria, and required close-set shape. |
| `docs/design-v0.6.0/arc16-book-0.6.0-edition/slice01-pre-book-decision-gate/ledger.md` | F-1...F-10 criteria closed by this report. |
| `docs/design-v0.6.0/arc16-book-0.6.0-edition/slice01-pre-book-decision-gate/cc-prompt.md` | CC execution contract for this slice. |
| `docs/design-v0.6.0/arc16-book-0.6.0-edition/design/kickoff-thread-book-0.6.0-update.md` | Historical May kickoff assumptions, especially the stale book example-test tree, raw Deno, and book `AGENTS.md` claims. |
| `docs/design-v0.6.0/arc16-book-0.6.0-edition/design/book-drift-inventory-0.6.0.md` | Historical D-1...D-5 decision rows and Bucket 0 drift inventory. |
| `docs/design-v0.6.0/arc16-book-0.6.0-edition/design/fence-wiring-spec.md` | `D-2607-R4NW` design spec for making book `lisp` fences reachable. |
| `docs/design-v0.6.0/arc16-book-0.6.0-edition/design/dogfooding-friction-log.md` | Source for `D-2608-XPRT`, `D-2608-LBND`, `D-2608-COND`, and `D-2608-SOWN`. |
| `docs/backlog/discoveries.md` | Current discovery-register status for the decision rows. |
