...
| **arc16 · book-0.6.0-edition** | The Lykn Book's 0.6.0 edition drafted to completion — the full-surface review that catches language and DevX defects **before** the release, not in point releases after it | arc01–08, arc10–13, arc15 (describes shipped behaviour); pairs with arc07 (guides) | **Open — slice04 language-surface runway opened before book prose.** The confirmation-protocol decision (PROJECT-MANAGEMENT Part VI) was taken with the operator on 2026-07-25: **split by design** — the *plan* lives here at [`arc16-book-0.6.0-edition/`](./arc16-book-0.6.0-edition/) because this project's arc09 gates on it; the *content* stays in `~/lab/cnbb/lykn`, whose `AGENTS.md` points back here (as does `~/lab/cnbb/lykn-writers-guide`'s). The tracked design material lives under `arc16-book-0.6.0-edition/design/`. The CLI/scaffold/package runway has closed `D-2608-BINW`, `D-2608-TDSL`, `D-2608-BREC`, `D-2608-RIMP`, and the 0.6.0 floor for `D-2608-SOWN`; [`arc16-book-0.6.0-edition/slice04-language-surface-runway/`](./arc16-book-0.6.0-edition/slice04-language-surface-runway/) now opens the implementation route for `D-2608-XPRT`, `D-2608-LBND`, and `D-2608-COND` before any chapter work proceeds. |
...
- **Open standalone work:** none. `02-artifact-homes` and
  ...
  green at HEAD.
- **Open arcs:** arc16 (book arc-plan written; slice01 decision gate open).
...
| P-20 | **arc16 (Lykn Book 0.6.0 edition) drafted and closed** — the book's 0.6.0 edition is complete, and every language/DevX defect it surfaced is either fixed in 0.6.0 or routed with a named home | ptr: arc16 closing-report + the defect-routing table | **serious** | operator decision 2026-07-24 (release-gating call) | **open — slice04 language-surface runway opened** | [`arc16-book-0.6.0-edition/arc-plan.md`](./arc16-book-0.6.0-edition/arc-plan.md) opens the arc ledger and a 10-slice implementation-first plan; [`slice01-pre-book-decision-gate/closing-report.md`](./arc16-book-0.6.0-edition/slice01-pre-book-decision-gate/closing-report.md) and [`cdc-verification.md`](./arc16-book-0.6.0-edition/slice01-pre-book-decision-gate/cdc-verification.md) close A-1; [`slice02-dogfood-implementation-runway/closing-report.md`](./arc16-book-0.6.0-edition/slice02-dogfood-implementation-runway/closing-report.md) and [`cdc-verification.md`](./arc16-book-0.6.0-edition/slice02-dogfood-implementation-runway/cdc-verification.md) close the first dogfood/routing pass; [`slice03-cli-scaffold-package-runway/closing-report.md`](./arc16-book-0.6.0-edition/slice03-cli-scaffold-package-runway/closing-report.md) and [`cdc-verification.md`](./arc16-book-0.6.0-edition/slice03-cli-scaffold-package-runway/cdc-verification.md) close `D-2608-BINW`, `D-2608-TDSL`, `D-2608-BREC`, `D-2608-RIMP`, and the 0.6.0 floor for `D-2608-SOWN`; [`slice04-language-surface-runway/slice-doc.md`](./arc16-book-0.6.0-edition/slice04-language-surface-runway/slice-doc.md), [`ledger.md`](./arc16-book-0.6.0-edition/slice04-language-surface-runway/ledger.md), and [`cc-prompt.md`](./arc16-book-0.6.0-edition/slice04-language-surface-runway/cc-prompt.md) open the implementation route for dogfood F-7 / `D-2608-XPRT`, F-8 / `D-2608-LBND`, and F-9 / `D-2608-COND`; D-3 is resolved to tracked lang homes; D-1 / `D-2607-R4NW` has a fence-first recommendation | **Gates arc09.** Prerequisite (1) — *the plan gets a git home* — is met. Prerequisite (2) — *the decision packet exists* — is met. Prerequisite (3) has closed its first CLI/scaffold/package cluster and opened the language-surface implementation route; book/writers-guide/chapter slices remain blocked until slice04 closes or splits with explicit re-entry conditions. |
