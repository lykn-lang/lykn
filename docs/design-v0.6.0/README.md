...
| [arc16 · book-0.6.0-edition](./arc16-book-0.6.0-edition/arc-plan.md) | Lykn Book 0.6.0 edition; full-surface review before release | **Open** — slice01-slice04 closed/CDC-verified; slice05 `book-instruction-bootstrap` closed by CC / CDC pending; slice06 `book-fence-reachability` remains next before chapter work |
