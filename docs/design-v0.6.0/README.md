...
| [arc10 · compiler-completion](./arc10-compiler-completion/arc-plan.md) | DD-58 strict-default + JS-parity + DD-37 step-4 (`_kernel` removal) | **In flight** — slice01 (Rust CLI strict) + slice02 (JS parity, `feb056c`) closed; A-3 met; slice03 (`_kernel` removal) next; runs before arc05 |
