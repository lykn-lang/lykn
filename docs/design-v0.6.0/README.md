...
| [arc13 · expander-coherence](./arc13-expander-coherence/arc-plan.md) | Lexical bindings shadow macros on both backends; reserved words rejected; conformance corpus | **Open — 5 slices closed** (binding layer complete by construction; D2 everywhere; coverage test standing); **CLOSING** — all 11 slices closed 2026-07-09; DD-60 D1/D2 hold on both backends; corpus standing in `make check` (teeth demonstrated); matrix 1947/53 documented-as-intended; **formal close = operator host gate** (closing-report §5); on GO arc05 unpauses |
