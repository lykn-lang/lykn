...
| [arc07 · docs](./arc07-docs/arc-plan.md) | Guide/SKILL alignment with 0.6.0; clear guide drift | **Active** — slice01/slice02/slice03 closed/CDC-verified; slice04 Deno workflow reconciliation opened |
