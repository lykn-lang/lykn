...
| [arc16 · book-0.6.0-edition](./arc16-book-0.6.0-edition/arc-plan.md) | Lykn Book 0.6.0 edition; full-surface review before release | **Open** — slice01 and slice02 closed/CDC-verified 2026-08-08; implementation routing is next for CLI/scaffold/package and language-surface findings before book/writers-guide/chapter prose normalizes the final surface |
