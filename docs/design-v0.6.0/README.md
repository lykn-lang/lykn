...
| [arc05 · lykn-source-linter](./arc05-lykn-source-linter/arc-plan.md) | `lykn lint` over Lykn source | **RESUMED** (arc13 gate GO 2026-07-09) — 15 rules live at 2/3; **slice03 is the next work**: lint consumes resolution; the ID-42 re-answer (closes arc13 A-6); shadowing rule; guide-09 labels; suppression; `make lint`; P-11 |
