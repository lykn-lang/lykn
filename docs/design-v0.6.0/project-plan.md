...
> (**checked 2026-08-08**): **arc15 slice04 + arc15 close -> arc07 (docs) +
> arc16 (book) -> arc09
> (release).** arc07 and
...
**Sequence update.** With artifact homes closed, the next work is arc15
slice04 + arc15 close, then arc07 + arc16, then arc09.
