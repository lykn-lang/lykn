...
- **Open arcs:** arc10 (reopened: slice04 draft planned), arc07 (active:
  slice03 build/dist/publish guide refresh opened), arc16 (book arc-plan still
  to write).
