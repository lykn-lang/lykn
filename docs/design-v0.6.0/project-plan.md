...
- **Open standalone work:** none. `02-artifact-homes` and
  ...
  green at HEAD.
- **Open arcs:** arc16 (slice01-slice04 closed/CDC-verified; slice05 closed by
  CC with CDC pending; slice06 `book-fence-reachability` remains next).
