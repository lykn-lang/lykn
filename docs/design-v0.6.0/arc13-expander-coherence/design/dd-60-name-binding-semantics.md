...
> edge-case coverages) and odm-tracked as odm 0062.** The odm copy is
> canonical going forward; amendments land there (refinement-log pattern,
> per DD-58/odm-0059 practice) — this arc13 design-tree copy is retained
> for the arc's provenance and CC-prompt references. Drafted by CC
> 2026-07-06 from the arc13/slice01 conformance matrix
> (`tools/conformance-matrix.js`, 885 cells, both backends). Slices 02
> (Rust) and 03 (JS + corpus) implement it.
