...
**Design authority**:
- `project01-mvp/arc02-macro-system/artifacts/design/06-final/0013-dd-10-quasiquote-unquote-splicing.md` (reader desugaring)
- `project01-mvp/arc02-macro-system/artifacts/design/06-final/0015-dd-12-reader-dispatch-data-literals-and-cons-lists.md` (dispatch table, radix, block comments, dotted pairs)
